...
const Header = () => {
  ...
  return (
    <>
      ...
      <header
        className={clsx(
          "fixed top-0 left-0 z-1 flex w-dvw flex-col justify-between px-3 py-6 transition duration-300 ease-in-out md:static md:h-auto md:w-auto md:flex-row md:bg-transparent md:p-0",
          isMenuOpen && "h-dvh bg-white",
        )}
      >
